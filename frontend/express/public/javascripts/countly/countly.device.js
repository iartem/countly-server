(function(countlyDevice, $, undefined) {
	...
	function deviceFullName(shortName) {
		...
		switch (shortName) {
			...
			case "iPhone5,2": fullName = "iPhone 5 (CDMA)"; break;
			...
			case "iPad2,5":	fullName = "iPad mini"; break;
			case "iPad2,6":	fullName = "iPad mini (GSM)"; break;
			case "iPad2,7":	fullName = "iPad mini (CDMA)"; break;
			case "iPad3,1":	fullName = "iPad-3G (WiFi)"; break;
			case "iPad3,2":	fullName = "iPad-3G (4G)"; break;
			case "iPad3,3":	fullName = "iPad-3G (4G)"; break;
			case "iPad3,4":	fullName = "iPad 4"; break;
			case "iPad3,5":	fullName = "iPad 4 (GSM)"; break;
			case "iPad3,6":	fullName = "iPad 4 (CDMA)"; break;
